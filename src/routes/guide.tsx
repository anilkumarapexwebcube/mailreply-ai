      ...
      <main className="mx-auto max-w-3xl px-6 pb-24 pt-10">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            A simple, step-by-step guide to getting your AI assistant ready in Gmail.
          </p>
        </div>
        ...
        <div className="space-y-12">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2 text-muted-foreground">
                <li className="flex items-start gap-2">
                  ...
                  <span>Download the extension folder from your dashboard and unzip it.</span>
                </li>
                <li className="flex items-start gap-2">
                  <ArrowRight className="mt-1 size-4 shrink-0 text-primary" />
                  <span>Open <code className="rounded bg-muted px-1.5 py-0.5 text-sm text-foreground">chrome://extensions</code> in a new tab.</span>
                </li>
                <li className="flex items-start gap-2">
                  <ArrowRight className="mt-1 size-4 shrink-0 text-primary" />
                  <span>Turn on <strong>Developer mode</strong> (top right corner).</span>
                </li>
                <li className="flex items-start gap-2">
                  <ArrowRight className="mt-1 size-4 shrink-0 text-primary" />
                  <span>Click <strong>Load unpacked</strong> and select your unzipped folder.</span>
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="surface flex flex-col gap-6 p-8 md:flex-row md:items-start">
            ...
            <div>
              ...
              <p className="mt-3 text-muted-foreground leading-relaxed">
                You're all set! Open any email in Gmail. You will see a new <strong>✦ AI Reply</strong> button next to the usual reply options.
              </p>
              <div className="mt-4 rounded-xl border border-border bg-muted/50 p-4">
                <p className="text-sm font-medium text-foreground">Here is how to use it:</p>
                <ol className="mt-2 list-decimal space-y-1 pl-4 text-sm text-muted-foreground">
                  <li>Click <strong>✦ AI Reply</strong>.</li>
                  <li>Type a short instruction (e.g., "Tell them I'm busy until Friday").</li>
                  <li>Choose your preferred tone (Professional, Friendly, etc.).</li>
                  <li>Click <strong>Generate reply</strong>.</li>
                  <li>Review the AI's draft, make changes if you want, and click <strong>Insert</strong>.</li>
                </ol>
              </div>
              <p className="mt-4 flex items-center gap-2 text-sm font-medium text-muted-foreground">
                <ShieldCheck className="size-4 text-primary" />
                You are always in control. Emails are never sent automatically without your permission.
              </p>
            </div>
          </section>
        </div>
        ...
        <div className="mt-16 text-center">
          <Button asChild size="lg" className="rounded-full px-8 text-base shadow-lg hover:shadow-xl transition-shadow">
